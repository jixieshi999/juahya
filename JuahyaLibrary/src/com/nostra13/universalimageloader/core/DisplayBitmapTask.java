...
final class DisplayBitmapTask implements Runnable {
	...
	public void run() {
		if (isViewWasReused()) {
            ...
            File tmpImageFile = StorageUtils.getDiscCacheFile(imageUri, engine.configuration.discCache, engine.configuration.reserveDiscCache);
			listener.onLoadingComplete(imageUri, imageView, displayedBitmap,tmpImageFile.getAbsolutePath());
