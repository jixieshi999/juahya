	...
	public void displayImage(String uri, ImageView imageView, DisplayImageOptions options, ImageLoadingListener listener) {
		...
		if (bmp != null && !bmp.isRecycled()) {
			...
			if (options.shouldPostProcess()) {
				...
				File tmpImageFile = StorageUtils.getDiscCacheFile(uri, configuration.discCache, configuration.reserveDiscCache);
	            
				listener.onLoadingComplete(uri, imageView, bmp,tmpImageFile.getAbsolutePath());
			}
		} else {
