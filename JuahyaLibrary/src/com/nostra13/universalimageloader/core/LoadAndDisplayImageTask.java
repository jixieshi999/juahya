...
final class LoadAndDisplayImageTask implements Runnable {
	...
	private Bitmap tryLoadBitmap() {
        ...
        File imageFile = StorageUtils.getDiscCacheFile(uri, configuration.discCache, configuration.reserveDiscCache);
		...
		try {
			...
			Debug.dLog("getAbsolutePath:"+imageFile.getAbsolutePath());
			...
			Debug.dLog("tryLoadBitmap:"+imageUriForDecoding.toString());
