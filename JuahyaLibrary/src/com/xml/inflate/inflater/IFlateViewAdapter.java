 ...
 * */
public abstract class IFlateViewAdapter implements IBaseInflateInterface {
	...
	public String NAMESPACE_JUAHYA="juahya";
...
//				LinearLayout.LayoutParams linearlayoutparam=(LinearLayout.LayoutParams)param;
				...
				if(NONE_INT!=topMargin)linearlayoutparam.topMargin=topMargin;
				if(NONE_INT!=bottomMargin)linearlayoutparam.bottomMargin=bottomMargin;
				if(NONE_INT!=leftMargin)linearlayoutparam.leftMargin=leftMargin;
				if(NONE_INT!=rightMargin)linearlayoutparam.rightMargin=rightMargin;
				if(NONE_INT!=layout_gravity)linearlayoutparam.gravity=layout_gravity;
...
//				RelativeLayout.LayoutParams relativelayoutparam=(RelativeLayout.LayoutParams) param;
				...
				if(NONE_INT!=topMargin)relativelayoutparam.topMargin=topMargin;
				if(NONE_INT!=bottomMargin)relativelayoutparam.bottomMargin=bottomMargin;
				if(NONE_INT!=leftMargin)relativelayoutparam.leftMargin=leftMargin;
				if(NONE_INT!=rightMargin)relativelayoutparam.rightMargin=rightMargin;
